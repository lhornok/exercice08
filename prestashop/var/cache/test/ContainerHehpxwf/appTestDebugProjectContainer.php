...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'prestashop.bundle.routing.converter.cache' => 'getPrestashop_Bundle_Routing_Converter_CacheService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ZjiHIkHtuO', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('t1FyzCVGc1', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'test_prestashop', 'user' => 'prestashopuser', 'password' => '+QAY2wsx3edc', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.0999999999999996, 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_80456231a0a3a6a84c4312edeffa57ca7c3e1d69cca85829e1e54a5c6f03d6c8');
    ...
    protected function getPrestashop_Addons_ClientApiService()
    {
        ...
        $instance->setSslVerification(($this->targetDirs[3].'/tests-legacy/PrestaShopBundle/Utils/../../../var/cache/dev/cacert.pem'));
    ...
    {
        return $this->services['session'] = new \Symfony\Component\HttpFoundation\Session\Session(${($_ = isset($this->services['session.storage.filesystem']) ? $this->services['session.storage.filesystem'] : $this->getSession_Storage_FilesystemService()) && false ?: '_'}, new \Symfony\Component\HttpFoundation\Session\Attribute\AttributeBag(), new \Symfony\Component\HttpFoundation\Session\Flash\FlashBag());
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JYaUvo9lEA', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('whAMQCkb2G', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->services['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ${($_ = isset($this->services['prestashop.security.voter.product']) ? $this->services['prestashop.security.voter.product'] : ($this->services['prestashop.security.voter.product'] = new \LegacyTests\PrestaShopBundle\Mock\PageVoter())) && false ?: '_'};
    ...
    /**
     * Gets the private 'prestashop.bundle.routing.converter.cache' shared service.
     *
     * @return \Symfony\Component\Cache\Adapter\ArrayAdapter
     */
    protected function getPrestashop_Bundle_Routing_Converter_CacheService()
    {
        return $this->services['prestashop.bundle.routing.converter.cache'] = new \Symfony\Component\Cache\Adapter\ArrayAdapter();
    }
    ...
    /**
     * Gets the private 'session.storage.filesystem' shared service.
     *
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('pSGLKVng1wQ0cKTa7MrV55H7051ODMPoiO9Wifu1WCYSyKf15EW3DJUG');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'env(PS_LOG_OUTPUT)': $value = ($this->targetDirs[2].'/logs/test.log'); break;
            ...
            case 'ps_cache_dir': $value = ($this->targetDirs[3].'/tests-legacy/PrestaShopBundle/Utils/../../../var/cache/dev/'); break;
            case 'prestashop.addons.api_client.verify_ssl': $value = ($this->targetDirs[3].'/tests-legacy/PrestaShopBundle/Utils/../../../var/cache/dev/cacert.pem'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'secret' => 'pSGLKVng1wQ0cKTa7MrV55H7051ODMPoiO9Wifu1WCYSyKf15EW3DJUG',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2020-09-12',
            'locale' => 'fr-FR',
            'cookie_key' => 'r0LjFkhIaf1HADhNiqHwHCFI3DwiLVsaZLQXiL3NLs2dgH71Pcp0RVQ2',
            'cookie_iv' => 'fpBavQLX',
            'new_cookie_key' => 'def000009a14fc4db37df9af68c190f9c5c8a230f9377fa27d1cc89c69473598584f630175dedf6766280b6495f8d754b96cab8c77ce3b6f395d3acf99895a7116ddb23f',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'pSGLKVng1wQ0cKTa7MrV55H7051ODMPoiO9Wifu1WCYSyKf15EW3DJUG',
